...
import { Navigation, PlusCircle, Mic, MicOff, Shield } from 'lucide-react';
...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 flex flex-col selection:bg-teal-500 selection:text-slate-950">
      ...
      {/* Main Canvas */}
      <main className="flex-1 pb-20 pt-4 px-2 sm:px-6">
        
        {/* Responsive Layout container (Mobile view on small screens, full grid on large screens) */}
